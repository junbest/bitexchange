                                        ...
                                        <li class="nav-item">
                                            <?php
                                                if($active_currency_id == 44)
                                                    ...
                                                    $class_active = "";
                                            ?>
                                            <a class="nav-link <?php echo $class_active;  ?>" id="r-bch-tab" data-toggle="tab" href="#r-bch" role="tab" aria-controls="r-bch" aria-selected="false">BCH</a>
                                        </li>
                                        <li class="nav-item">
                                            <?php
                                                if($active_currency_id == 43)
                                                    ...
                                                    $class_active = "";
                                            ?>
                                            <a class="nav-link <?php echo $class_active;  ?>" id="r-zec-tab" data-toggle="tab" href="#r-zec" role="tab" aria-controls="r-zec" aria-selected="false">ZEC</a>
                                        </li>
                                        <li class="nav-item">
                                            <?php
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade <?php echo $class_active;  ?>" id="r-usd" role="tabpanel" aria-labelledby="r-usd-tab">
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'USD') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BCH-USD&c_currency=44&currency=27">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'USD') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ZEC-USD&c_currency=43&currency=27">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                        ...
                                        <div class="tab-pane fade <?php echo $class_active;  ?>" id="r-btc" role="tabpanel" aria-labelledby="r-btc-tab">
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BCH-BTC&c_currency=44&currency=28">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'BTC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ZEC-BTC&c_currency=43&currency=28">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                        ...
                                        <div class="tab-pane fade <?php echo $class_active;  ?>" id="r-ltc" role="tabpanel" aria-labelledby="r-ltc-tab">
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ZEC-LTC&c_currency=43&currency=42">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'LTC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BCH-LTC&c_currency=44&currency=42">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                        ...
                                        <div class="tab-pane fade <?php echo $class_active;  ?>" id="r-bch" role="tabpanel" aria-labelledby="r-bch-tab">
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTC' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BTH-BCH&c_currency=28&currency=44">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ETH-BCH&c_currency=45&currency=44">
                                                        <td>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ZEC-BCH&c_currency=43&currency=44">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'BCH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=LTC-BCH&c_currency=42&currency=44">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                        ...
                                        <div class="tab-pane fade <?php echo $class_active;  ?>" id="r-zec" role="tabpanel" aria-labelledby="r-zec-tab">
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BTC' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BTC-ZEC&c_currency=28&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'LTC' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=LTC-ZEC&c_currency=42&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ETH' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ETH-ZEC&c_currency=45&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'BCH' && $currency_info['currency'] == 'ZEC') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=BCH-ZEC&c_currency=44&currency=43">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                        ...
                                        <div class="tab-pane fade <?php echo $class_active;  ?>" id="r-eth" role="tabpanel" aria-labelledby="r-eth-tab">
                                            <table class="table row-border right-data-table table-hover" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="clickable-row" data-href="userbuy?trade=BCH-ETH&c_currency=44&currency=45">
                                                        <td>
                                                            <div class="star-inner text-left" style="font-size:9px">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
                                                    ...
                                                    <tr class="clickable-row <?= ($c_currency_info['currency'] == 'ZEC' && $currency_info['currency'] == 'ETH') ? 'userbuy-active' : "" ?>" data-href="userbuy?trade=ZEC-ETH&c_currency=43&currency=45">
                                                        <td>
                                                            <div class="star-inner text-left">
                                                                <input id="star1" type="checkbox" name="time" />
                                                                <label for="star1"></label>
