    ...
    // ini_set('display_errors', 1);
        ...
        // $c_sql = "SELECT currency,(SELECT currency FROM currencies WHERE id = $c_currency_id) as c_currency FROM currencies WHERE id = $currency_id"
        // // $cur_sql = "SELECT currency FROM currencies WHERE id = $c_currency_id";
        // // $currency_query = mysqli_query($conn,$cur_sql);
        // // $currencies = mysqli_fetch_assoc($currency_query);

        // // $t_currency = $currencies['currency'];
        // // //var_dump($currencies['currency']); exit;

        // // $cur_sql = "SELECT currency FROM currencies WHERE id = $currency_id";
        // // $currency_query = mysqli_query($conn,$cur_sql);
        // // $currencies = mysqli_fetch_assoc($currency_query);
        // // $f_currency = $currencies['currency'];
        // $ex = mysqli_query($conn,$cur_sql);
        // $currencies = mysqli_fetch_assoc($currency_query);
        // $t_currency = $currencies['c_currency'];
        // $f_currency = $currencies['currency'];

        //$_REQUEST['trade'] = $f_currency.'-'.$t_currency;
        ...
        <body id="wrapper">
            ...
            <div class="page-container">
                <div class="" style="/*margin-bottom: 15%*/">
                       <!-- <div class="row">
                        <div class="col-md-12">
                            <div class="left-side-widget" style="background-color: #2f3340;margin-top: 0px;border-left: 0px;">
                            <div class="bg-white"  style="background-color: #2f3340 !important;">
                            <div class="head-splits name">
                                <h4 class="title" style="color: white;"><?= $c_currency_info['currency'] ?><span class="gray-color">/<?= $currency_info['currency'] ?></span></h4>
                                <p><?= $c_currency_info['currency'] ?></p>
                            </div>
                            <div class="head-splits">
                                <p class="small gray-color">Last Price</p>
                                <p class="amount"><strong><span class="green-color"><?= number_format($currentPair['lastPrice'], 8) ?></span> $0.00</strong></p>
                            </div>
                            <div class="head-splits">
                                <p class="small gray-color">24h change</p>
                                <p class="amount"><strong><span class="red-color"><?= number_format($currentPair['change_24hrs'], 8) ?></span> $0.00</strong></p>
                            </div>
                           <div class="head-splits">
                                <p class="small gray-color">24h High</p>
                                <p class="amount"><strong><span class="gray-color">0.000000</span> $0.00</strong></p>
                            </div>
                            <div class="head-splits">
                            ...
                            <div class="head-splits">
                                ...
                                <p class="amount"><strong><span class="gray-color"><?= number_format($currentPair['transactions_24hrs'], 8) ?></span> <?= $c_currency_info['currency'] ?> $0.00</strong></p>
                            </div>
                           ...
                           <!--  <form action="" class="form-inline" style="padding: 20px;background: white;margin-top: 20px;">
                            ...
                            <!-- <div class="left-side-widget">
                                <div class="bg-white">
                                    <ul>
                                        <li>The Advanced Trade page lets you Buy / Sell cryptocurrencies on this exchange.</li>
                    ...
                    <div class="row" >
                      ...
                      ?>
                       <h6 class="right-side-widget-title" style="display: none;"><strong class="heading-one">Open Orders on Market</strong>
    ...
    <br><br>
     <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 no-padding" style="padding-left: 10px !important;padding-right: 10px !important;">
     <div class="left-side-widget">
      <div id="chartdiv" style="background-color: #fff;"></div> 
                            ...
                            <?php
                    // $date23 = date("D F jS Y G:i:s T O");
                      // echo $date23;
    ...
    // $my_query = mysqli_query($conn,$sql);
                    ...
                    ?>
                    <!-- <p id="hello"><?php $value111// = mysqli_fetch_assoc($my_query); print_r($value111);?></p>. -->
                    <!-- <p id="date_formate"><?php $date23  ?></p> -->
                            <?php
                            // @include("chart.php");
                            // $timestamp = strtotime($value111['date']);
    // $newDate = date('D M j  Y', $timestamp); 
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 no-padding">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" title="Buy Orders">
                                        <a class="nav-link active" id="buy-tab" data-toggle="tab" href="#buy" role="tab" aria-controls="buy" aria-selected="true"><img src="sonance/img/icons/buy.jpg"><span style="font-size: 10px;margin-left: 5px;font-weight: 600;">Buy Orders1</span></a>
                                    </li>
                                    ...
                                    <tbody>
                                        <? 
                                            ...
                                            <tr id="ask_'.$ask['id'].'" class="ask_tr '.$blink.'">
                                                ...
                                                <td> <a href="edit_userbuy.php?trade=BTC-USD&order_id='.$ask['id'].'" title="'.Lang::string('orders-edit').'"><i class="fa fa-edit"></i></a>
